    ...
    <div className="space-y-8">
      <header>
        <div className="flex items-center gap-3 mb-2">
          ...
          {mod.isNew && (
            <span className="text-[10px] font-bold tracking-widest px-2 py-0.5 rounded bg-accent-500 text-black">
              NEW
            </span>
          )}
        </div>
        <h1 className="text-3xl font-bold flex items-center gap-3">{mod.label}</h1>

...
export const MODULES: ModuleSpec[] = [
  ...
  { country: 'eu', slug: 'ted', label: 'TED Tenders', description: 'EU public procurement notices', inputLabel: 'Country code (CZ/SK/PL/…)', exampleId: 'CZ', status: 'working', isNew: true },
  { country: 'eu', slug: 'domain', label: 'Domain (RDAP)', description: 'Domain WHOIS — registrar, dates, NS', inputLabel: 'Domain name', exampleId: 'orange.pl', status: 'working', isNew: true },
  { country: 'eu', slug: 'stats', label: 'Eurostat', description: 'GDP, inflation, unemployment, population, debt', inputLabel: 'Country code (CZ/SK/PL/…)', exampleId: 'CZ', status: 'working', isNew: true },

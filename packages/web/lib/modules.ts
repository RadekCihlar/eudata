...
export const MODULES: ModuleSpec[] = [
  ...
  { country: 'cz', slug: 'court', label: 'Court (justice.cz)', description: 'Commercial register', inputLabel: 'ICO', exampleId: '64774716', status: 'experimental', note: 'HTML scraping; selectors are placeholders' },

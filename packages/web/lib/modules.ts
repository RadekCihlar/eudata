...
export const MODULES: ModuleSpec[] = [
  // CZ
  { country: 'cz', slug: 'company', label: 'Company (ARES)', description: 'Business registry', inputLabel: 'ICO', exampleId: '64774716', status: 'working' },
  { country: 'cz', slug: 'insolvency', label: 'Insolvency (ISIR)', description: 'Bankruptcy proceedings', inputLabel: 'ICO', exampleId: '64774716', status: 'working' },
  { country: 'cz', slug: 'vat', label: 'VAT', description: 'Reliability + bank accounts', inputLabel: 'ICO or DIC', exampleId: 'CZ64774716', status: 'experimental', note: 'SOAP envelope may need adjustment' },
  { country: 'cz', slug: 'trade', label: 'Trade (RŽP)', description: 'Trade license via ARES', inputLabel: 'ICO', exampleId: '64774716', status: 'working' },
  { country: 'cz', slug: 'execution', label: 'Execution (CEECR)', description: 'Debt enforcement', inputLabel: 'ICO', exampleId: '64774716', status: 'broken', note: 'CEECR has no public API; needs HTML scraping with valid selectors' },
  ...
  { country: 'cz', slug: 'court', label: 'Court (justice.cz)', description: 'Commercial register', inputLabel: 'ICO', exampleId: '64774716', status: 'broken', note: 'or.justice.cz uses Apache Wicket with stateful URLs; needs session cookies + form posts, not implementable as simple HTML scrape' },
  ...
  { country: 'cz', slug: 'environment', label: 'Environment (IRZ)', description: 'Emissions + violations', inputLabel: 'ICO', exampleId: '64774716', status: 'broken', note: 'IRZ has no API; data only via bulk downloads' },
  ...
  { country: 'sk', slug: 'financial', label: 'Financial', description: 'registeruz.sk statements', inputLabel: 'IČO', exampleId: '36421928', status: 'broken', note: 'registeruz.sk blocks API access from non-browser UAs' },
  { country: 'sk', slug: 'court', label: 'Court (otvorenesudy)', description: 'Decisions', inputLabel: 'IČO', exampleId: '36421928', status: 'broken', note: 'otvorenesudy API deprecated' },
  { country: 'sk', slug: 'contracts', label: 'Contracts (CRZ)', description: 'Public contracts', inputLabel: 'IČO', exampleId: '36421928', status: 'broken', note: 'CRZ API v2 path needs verification' },
  { country: 'sk', slug: 'tenders', label: 'Tenders (ÚVO)', description: 'Procurement', inputLabel: 'IČO', exampleId: '36421928', status: 'broken', note: 'Host unreachable' },
  { country: 'sk', slug: 'ubo', label: 'UBO (RPVS)', description: 'Beneficial owners', inputLabel: 'IČO', exampleId: '36421928', status: 'broken', note: 'Portal only' },
  { country: 'sk', slug: 'risk', label: 'Risk Assessment', description: 'SK composite score', inputLabel: 'IČO', exampleId: '36421928', status: 'broken', note: 'Depends on broken sources' },

  // PL
  { country: 'pl', slug: 'company', label: 'Company (KRS)', description: 'National Court Register', inputLabel: 'KRS', exampleId: '0000019193', status: 'experimental', note: 'Use KRS number not NIP; byNIP requires search flow' },
  { country: 'pl', slug: 'sole-trader', label: 'Sole Trader (CEIDG)', description: 'Sole proprietorships', inputLabel: 'NIP', exampleId: '5213003798', status: 'needs_key', note: 'CEIDG v2 requires free API key from biznes.gov.pl' },
  { country: 'pl', slug: 'vat', label: 'VAT (White List)', description: 'Bank account verification', inputLabel: 'NIP', exampleId: '5260250274', status: 'working' },
  { country: 'pl', slug: 'insolvency', label: 'Insolvency (KRZ)', description: 'Bankruptcy register', inputLabel: 'NIP', exampleId: '5260250274', status: 'broken', note: 'KRZ portal requires session — no public API' },
  { country: 'pl', slug: 'ubo', label: 'UBO (CRBR)', description: 'Beneficial owners', inputLabel: 'NIP', exampleId: '5260250274', status: 'broken', note: 'Portal only' },

...
import { vies, sanctions as euSanctions, lei, trademark, universal, fx, geocode, wikidata, parseIBAN, parsePESEL, euTenders, domain, stats } from 'eudata'
...
const handlers: Record<string, Handler> = {
  ...
  'eu/ted': async (id) => euTenders.search({ country: id.toUpperCase(), limit: 10 }),
  'eu/domain': async (id) => domain.lookup(id),
  'eu/stats': async (id) => stats.summary(id.toUpperCase()),
}
